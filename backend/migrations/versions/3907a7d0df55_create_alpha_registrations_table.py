"""create alpha_registrations table

Revision ID: 3907a7d0df55
Revises: 
Create Date: 2026-04-03 10:16:41.293174
...
def upgrade() -> None:
    ...
    op.drop_index('idx_media_chapter_id', table_name='media')
...
def downgrade() -> None:
    ...
    op.create_index('idx_media_chapter_id', 'media', ['chapter_id'], unique=False)
